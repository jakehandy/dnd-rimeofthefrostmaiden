...
- Shared rumor that an Arcane Brotherhood wizard was causing a stir in Easthaven.
- Joined the White Moose hunt with Za'mora, Hadrian, and Tar.
- Interrogated a captured awakened badger.
...
## Canonical portrait
- Source image: `data/sources/character-portraits/2026-02-09_arhjay.png`

## Visual profile (portrait source)
- Large, blue-skinned, elemental-looking humanoid.
- Antler-like horns and crystal growths, including head crest.
- Heavy natural/fur-like garb with primal earth-magic vibe.
- Floating shards/stones and magic effects near hands.

## Keep consistent in generated scenes
- Massive frame with stony/primal silhouette.
- Blue skin tone with crystal-orange accents.
