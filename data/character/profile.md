...
Status: `Confirmed from source images (partial text limits)`
...
## Appearance cues from sheet text
- Skin: Slate-gray with patches of jagged, calcified rock
- Eyes: Piercing orange
...
## Skill highlights (sheet modifiers)
- Arcana: +2
- Insight: +5
- Nature: +4
- Perception: +5
...
- Homebrew source: `data/sources/campaign-docs/2026-02-09_tar-mountain-form-homebrew.md`
